...
<body>
  ...
  <div class="container-contact100">
    <div class="wrap-contact100">
      <form class="contact100-form validate-form" action="/booksubmithotel/{{ $id }}"  method="POST">
        {{ csrf_field() }}
        ...
        <div class="wrap-input100 ">
         ...
         <div class="wrap-input100 " >
         <div>
    <span class="firstLabel">Check In</span>
    <!-- <span class="secondLabel">Check Out</span> -->
</div>
    <div class="container">
    <div class="row">
        <div class='col-sm-6'>
            <div class="form-group">
                <div class='input-group date w-50' id='datetimepicker1' >
                   ...
                   <!--  <div class='input-group date' style="left: 200px; bottom: 43px;" id='datetimepicker1'>
                ...
                <!--  checkin:<br>
  <input type="date"   placeholder="mm/dd/yyyy" name="CheckInDate"/  required>
  <br>
   checkOut:<br>
  <input type="date"   placeholder="mm/dd/yyyy" name="CheckOutDate"/  required>
  <br> -->
         <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
          <label class="label-input100" for="email">Rooms</label>
          <input id="room" class="input100" type="text" name="room" placeholder="Enter your required rooms...">
          <span class="focus-input100"></span>
        </div>
